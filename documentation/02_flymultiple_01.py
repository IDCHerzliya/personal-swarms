...
#
"""
Version of the AutonomousSequence.py example connecting to 10 Crazyflies. This particular version will use 2 Crazyflies for now. The rest of the code has been truncated for testing purposes. The URI's of Magic Lab's swarms have been incorporated in this code. 

...
uris = [
    'radio://0/102/2M',  # cf_id 0, startup position [0.0, 0.0]
    'radio://0/104/2M',  # cf_id 1, startup position [ 0, 0]
    'radio://0/106/2M',  # cf_id 2, startup position [0.0, 0.0]
...
sequence = [
    ...
    (2,    0,      Goto(0.0,  0.0,   0.5, 10)),
    (2,    1,      Goto(0.0,  0.0,   0.5, 10)),
    (2,    2,      Goto(0.0,  0.0,   0.0, 10)),

#  (3,    1,      Goto(0,  0,   1, 1)),

    #(4,    0,      Ring(255, 255, 255, 0.0, 0)),
    #(4,    1,      Ring(255, 0, 0, 0.0, 0)),
    #(4,    2,      Ring(255, 255, 255, 0.0, 0)),

    (5,    0,      Goto(0.0, 0.0, 1, 20)),
    (5,    1,      Goto(0.0, 0.0, 1, 20)),
    (5,    2,      Goto(0.0, 0.0, 1, 20)),

    (7,    0,      Goto(0.0, 0.0, 0.5, 10)),
    (7,    1,      Goto(0.0, 0.0, 0.5, 10)),
    (7,    2,      Goto(0.0, 0.0, 0.0, 10)),

    (9,    0,      Goto(0.0, 0.0, 1, 20)),
    (9,    1,      Goto(0.0, 0.0, 1, 20)),
    (9,    2,      Goto(0.0, 0.0, 1, 20)),

    (11,   0,      Goto(0.0, 0.0, 0.5, 10)),
    (11,   1,      Goto(0.0, 0.0, 0.5, 10)),
    (11,   2,      Goto(0.0, 0.0, 0.3, 10)),
